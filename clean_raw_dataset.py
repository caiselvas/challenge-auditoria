...
info_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Inf.')
accounting_info_1_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='info_comptable_1')
accounting_info_2_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='info_comptable_2')
sales_2023_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Vendes 2023')
sales_2022_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Vendes 2022')
catalog_prices_2023_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Preus de venda catàleg 2023')
last_exit_entry_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Darrera entrada-sortida')
stock_31_12_2023_df = pd.read_excel('data/inventory_data.xlsx', sheet_name='Stock 31.12.23')
...
sales_2023_df.rename(columns={'Material (Referencia)': 'material', 'Quantitat facturada': 'quantitat', 'Ventes (sense IVA)': 'ventes'}, inplace=True)
sales_2022_df.rename(columns={'Material (Referencia)': 'material', 'Quantitat facturada': 'quantitat', 'Ventes (sense IVA)': 'ventes'}, inplace=True)
